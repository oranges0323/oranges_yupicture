...
/** createPictureOutPaintingTask POST /api/picture/out-painting/create_task */
export async function createPictureOutPaintingTaskUsingPost(
  ...
  return request<API.BaseResponseCreateOutPaintingTaskResponse_>(
    '/api/picture/out-painting/create_task',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** getPictureOutPaintingTask GET /api/picture/out-painting/get_task */
export async function getPictureOutPaintingTaskUsingGet(
  ...
  return request<API.BaseResponseGetOutPaintingTaskResponse_>(
    '/api/picture/out-painting/get_task',
    {
      method: 'GET',
      params: {
        ...params,
